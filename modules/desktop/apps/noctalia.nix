{
  flake.wrappers.noctalia =
    ...
    # Noctalia desktop shell (bar/launcher/notifications) for niri.
    # The base package is threaded from the noctalia flake input in
    # modules/flake/wrappers.nix (Variant B — no overlay).
    {
      ...
      settings = {
        appLauncher = {
          ...
          showCategories = true;
          sortByMostUsed = true;
          # Bare `kitty` resolves to the wrapped terminal on the session PATH.
